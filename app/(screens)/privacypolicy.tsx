                ...
                <View className="flex-1">
                    <ScrollView showsVerticalScrollIndicator={false}>
                        <View className='flex flex-col p-4 gap-y-4'>
                            ...
                            <Text className='text-base font-psemibold'>Information We Collect</Text>
                            <Text className='text-sm font-regular'>
                            ...
                            <Text className='text-base font-psemibold'>Your Rights</Text>
                            <Text className='text-sm font-regular'>
                            ...
                            <Text className='text-base font-psemibold'>Changes to This Policy</Text>
                            <Text className='text-sm font-regular'>
                                We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.
                            </Text>

                            <Text className='text-base font-psemibold'>Contact Us</Text>
                            <Text className='text-sm font-regular'>
